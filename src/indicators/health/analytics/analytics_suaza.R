...
process_analytics_suaza <- function(output_dir = here("outputs")) {
  ...
  cruce_csv     <- file.path(output_dir, "csv",     "analytics.csv")
  cruce_parquet <- file.path(output_dir, "parquet", "analytics.parquet")
  lags_csv      <- file.path(output_dir, "csv",     "analytics_lags.csv")
  lags_parquet  <- file.path(output_dir, "parquet", "analytics_lags.parquet")
